...
`30-knowledge/32-marketing/`처럼 지금 채워진 내용은 예시일 뿐입니다. 다른 직군이라면 [[customization-guide]]에서 뭘 유지하고 뭘 갈아끼우면 되는지 확인하세요. 더 깊이 파고들고 싶다면(자동 검증 규칙, 외부 도구 연동) [[30-knowledge/31-claude-code/04-hooks-mcp|Hooks & MCP 가이드]]도 참고할 만합니다.
